package co.com.nutriapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, co.com.nutriapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, co.com.nutriapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
