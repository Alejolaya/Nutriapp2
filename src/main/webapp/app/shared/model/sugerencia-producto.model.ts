...
export interface ISugerenciaProducto {
  ...
  unidadMedidaCasera?: ISugUnidadMedida;
  marca?: ISugMarca;
  categoria?: ISugCategoria;
  tags?: ISugTags[];
  nutrientesAdicionales?: ISugNutrientesAdicionales[];
}
...
export class SugerenciaProducto implements ISugerenciaProducto {
  constructor(
    ...
    public unidadMedidaCasera?: ISugUnidadMedida,
    public marca?: ISugMarca,
    public categoria?: ISugCategoria,
    public tags?: ISugTags[],
    public nutrientesAdicionales?: ISugNutrientesAdicionales[]
  ) {
